...
for game in video_game_sales:
    ...
    sales_by_genre[genre] = sales_by_genre.get(genre, 0) + sales 
...
top_game = {
    ...
    'year': top_row[YEAR],
    'genre': top_row[GENRE],
    'publisher': top_row[PUBLISHER],
    'global_sales': top_row[GLOBAL_SALES]
}

for key, value in top_game.items():
    print(f"{key}: {value}")# write your code here
